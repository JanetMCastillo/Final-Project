...
const DisplayReservation = ({ reservation, loadDashboard }) => {
    ...
    <>
        <div className={`card card-bg text-black row flex-column flex-md-row rounded-lg mx-1 my-3 px-2 py-2`} >
            ...
            <div className="col text-center">
                ...
                <div className={`col text-center align-self-center`}>
                    ...
                    <div>
                        <button
                            className="btn btn-xs btn-cancel text-dark btn-outline-dark d-block d-md-inline w-100"
                            type="button"
                            name="Cancel"
