...
export default function TableRow({ table }) {
  ...
  return (
    <tr style={{ fontFamily: "Courier" }} >
      <th className="text-center text-black" scope="row">{table.table_id}</th>
      <td className="text-center text-black">{table.table_name}</td>
      <td className="text-center text-black">{table.capacity}</td>
      <td className="text-center text-black" data-table-id-status={table.table_id}>
        {table.status}
      </td>
